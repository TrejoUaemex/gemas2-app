...
async def post_predict(file: UploadFile = File(...)):
    ...
    try:
        ...
        # 1. Correr la CNN de PyTorch directamente (se quitó validación visual de Gemini para ahorrar tokens)
        resultado = predecir(imagen)
        
        # 2. Generar una descripción fascinante de la gema con Gemini
